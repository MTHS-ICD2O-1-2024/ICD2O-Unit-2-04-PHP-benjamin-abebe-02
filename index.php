...
<head>
  <meta charset="utf-8" />
  <meta name="description" content="Calculating the Area and Perimeter of a Triangle with PHP!" />
  ...
  <title>Calculating the Area and Perimeter of a Triangle with PHP!</title>
</head>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Calculating the Area and Perimeter of a Triangle with PHP</span>
      </div>
    </header>
    <main class="mdl-layout__content">
      <div class="right-image">
        <img src="./area_of_trinagle.png" alt="Triangle Diagram" />
      </div>
